...
export const TID = {
  ...
  ticketFilterDepartment: "ticket-filter-department",
  ...
  editError: (index: number) => `edit-error-${index}`,
  ...
  auditFilterSince: "audit-filter-since",
  auditFilterUntil: "audit-filter-until",
