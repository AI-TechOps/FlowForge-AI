...
- **Build Phase 6** on `feat/phase6-dashboard`: tasks 1–3 and 5–16 (Claude), 4 and 17 (Codex). The ten MVP screens plus the read-only config panel, against a backend that needs no new endpoints.
