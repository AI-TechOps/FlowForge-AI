...
- **Build Phase 6** on `feat/phase6-dashboard`: tasks 1–3 and 5–16 (Claude), 4 and 17 (Codex). **Tasks 1–16 done** — task 4 landed as 13 Playwright gates in `tests/phase6/` covering G6.1–G6.5. Task 17 (adversarial pass + cold review) remains.
